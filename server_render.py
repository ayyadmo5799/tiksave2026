...
Module names prefixed tik_/dropbox_ to avoid Python stdlib conflicts.
"""
import os, sys, json
...
class MainHandler(BaseHTTPRequestHandler):
    ...
    def _route_api(self):
        ...
        try:
            ...
            h.rfile = self.rfile; h.wfile = self.wfile
            h.headers = self.headers; h.path = self.path; h.command = self.command
